...
public class AdastraSftpSlackNotifier extends SftpSlackNotifier {

    public String getCompleteBatchMessageSuffix(Batch completeBatch) {

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MMM-yyyy HH:mm");
        LocalDateTime extractDate = AdastraSftpFilenameParser.parseBatchIdentifier(completeBatch.getBatchIdentifier());
