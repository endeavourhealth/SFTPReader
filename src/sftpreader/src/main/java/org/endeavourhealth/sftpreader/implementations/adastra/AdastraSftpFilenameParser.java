...
public class AdastraSftpFilenameParser extends SftpFilenameParser {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AdastraSftpFilenameParser.class);


    public AdastraSftpFilenameParser(RemoteFile remoteFile, DbConfiguration dbConfiguration) {
