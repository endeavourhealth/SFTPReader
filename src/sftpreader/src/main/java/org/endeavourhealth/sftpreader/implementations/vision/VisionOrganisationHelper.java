...
public class VisionOrganisationHelper extends SftpOrganisationHelper {
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(VisionOrganisationHelper.class);
