...
public class Batch {
    ...
    private Date extractDate; //the date the extract was generated by the third party
    private Date extractCutoff; //the date of the last data to be included in the extract
