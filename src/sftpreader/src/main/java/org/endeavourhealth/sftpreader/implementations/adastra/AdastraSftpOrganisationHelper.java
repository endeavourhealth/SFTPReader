...
public class AdastraSftpOrganisationHelper extends SftpOrganisationHelper {
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(AdastraSftpOrganisationHelper.class);
